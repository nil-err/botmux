...
export const messages: Record<string, string> = {
  ...
  'cmd.reply_mode.status': 'Current group reply mode: {mode}\nCommands: /reply-mode chat | /reply-mode topic | /reply-mode alias',
  'cmd.reply_mode.updated': '✅ Group reply mode updated to: {mode}',
  'cmd.reply_mode.unsupported': '⚠️ /reply-mode only works in regular group chats; DMs and topic groups are unsupported.',
  'cmd.reply_mode.owner_only': '⚠️ Only owner/allowedUsers can change the group reply mode.',
  'cmd.reply_mode.usage': 'Usage: /reply-mode chat | /reply-mode topic | /reply-mode alias\nchat = flat replies in the group; topic = each @ opens a fresh topic + its own session; alias = reply inside a topic but reuse this chat session/context.',
