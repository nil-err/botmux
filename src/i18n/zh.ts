...
export const messages: Record<string, string> = {
  ...
  'cmd.reply_mode.status': '当前群回复模式：{mode}\n可用命令：/reply-mode chat｜/reply-mode topic｜/reply-mode alias',
  'cmd.reply_mode.updated': '✅ 已切换当前群回复模式为：{mode}',
  'cmd.reply_mode.unsupported': '⚠️ /reply-mode 仅支持普通群；私聊和话题群不支持该模式。',
  'cmd.reply_mode.owner_only': '⚠️ 只有 owner/allowedUsers 可以修改群回复模式。',
  'cmd.reply_mode.usage': '用法：/reply-mode chat｜/reply-mode topic｜/reply-mode alias\nchat=群内平铺回复；topic=每次 @ 都开一个独立话题+独立会话；alias=回复落在话题里但复用本群会话/上下文。',
